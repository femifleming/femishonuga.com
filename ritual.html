...
<body background="rrg2.jpeg">
<p><a href="https://sadnoise.bandcamp.com/album/ritual">RITUAL</a> is the first release in a series of Albums I'll be releasing every month for a year as part of my thesis. This series focuses on ideas of sound as ritual practice along with themes of <a href="arch.html">architecture</a>, <a href="dreams.html">dreams</a>, land acknowledgment, academia, indigenous practices, sexuality, love and relationships and the <a href="4chan.org">internet</a>. The purpose of this series is to really dive into the idea of recorded improvisation as a ritual practice and generative/<a href="code.html">algorithmic</a> systems as a connection to nature and the organic/organism. Sadnoise has always been as much about the conversation between the internet and nature or the &quot;absence&quot; of the internet as it has been about the interaction between produced or manipulated sound and physical space.</p>
<p><a href="https://sadnoise.bandcamp.com/album/ritual"><img src="ritual.jpeg" alt="" /></a>
Artwork by Hannah Rosies</p>
<p><a href="Systems.pdf">SYSTEMS</a> is an album archiving written and sonic explorations of various analog and digital systems that I use during the process of designing sound, as an attempt to demystify some synth esoteria.</p>
<p>Listening Instructions (suggested):
...
the track stories as the corresponding tracks play.</p>
<div align="center">
